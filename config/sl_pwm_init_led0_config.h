...
// <i> Default: 10000
#define SL_PWM_LED0_FREQUENCY       2000
#define SL_PWM_LED1_FREQUENCY       2000
#define SL_PWM_LED2_FREQUENCY       2000
#define SL_PWM_LED3_FREQUENCY       2000
...
#define SL_PWM_LED0_OUTPUT_PIN                   2
  ...
  #define SL_PWM_LED2_PERIPHERAL_NO                0

  #define SL_PWM_LED2_OUTPUT_CHANNEL               0
  // TIMER0 CC0 on PA04
  #define SL_PWM_LED2_OUTPUT_PORT                  gpioPortB
  #define SL_PWM_LED2_OUTPUT_PIN                   4



  // <timer channel=OUTPUT> SL_PWM_LED0
   // $[TIMER_SL_PWM_LED0]
   #define SL_PWM_LED3_PERIPHERAL                   TIMER3
   #define SL_PWM_LED3_PERIPHERAL_NO                0

   #define SL_PWM_LED3_OUTPUT_CHANNEL               0
   // TIMER0 CC0 on PA04
   #define SL_PWM_LED3_OUTPUT_PORT                  gpioPortC
   #define SL_PWM_LED3_OUTPUT_PIN                   0
